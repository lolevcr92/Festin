...
public class FragmentList extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate( R.layout.market_list_list, container, false );
        ...
        zagerman.add(new Product("Zagerman P1", R.drawable.zagermanp1, 35, "Product 2 description and others" ));
        zagerman.add(new Product("Zagerman P1", R.drawable.zagermanp1, 15, "Product 3 description and others" ));
        zagerman.add(new Product("Zagerman P1", R.drawable.zagermanp1, 20, "Product 4 description and others" ));
        zagerman.add(new Product("Zagerman P1", R.drawable.zagermanp1, 25, "Product 5 description and others" ));
        ...
        VendorAdapter adapter = new VendorAdapter(getActivity(), vendors, "list");
